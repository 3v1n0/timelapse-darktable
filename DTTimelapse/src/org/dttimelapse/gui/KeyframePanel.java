...
// this class constructs a Jpanel with display of icons for keyframes
// the position is at bottom of preview area
//    and can be changed to values of filter data
...
public class KeyframePanel extends JPanel {
	...
	protected void paintComponent(Graphics g) {
		...
		for (int i = 0; i < n; i++) {
			...
			// System.out.println("i= " + i + " xk= " + xScreen[i] + " yk= " +
			// yScreen[i]);
		}
	...
	public void setY(int YValues[]) {
		...
		for (int i = 0; i < n; i++) {
			yScreen[i] = YValues[indexKey[i]]; // set y-value at index of
												// keyframes
			// System.out.println("i= " + xValues[i] + " x= " + x[i]);
		}
		return;

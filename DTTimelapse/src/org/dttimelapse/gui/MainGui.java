...
public class MainGui extends JComponent {
        ...
        public MainGui() { // constructor
                ...
                JLabel labelLeft = new JLabel("Unaltered Preview");
                        ...
                        public void stateChanged(ChangeEvent e) {
                                ...
                                if (!slideShow.isAlive()) {
                                        ...
                                        picTable.scrollRectToVisible(new Rectangle(picTable
                                                        .getCellRect(activeIndex, picTable.getSelectedColumn(), true)));
                                }
...
//      }
     ...
     // methods to create some parts of the GUI
        ...
        public JPanel sliderPanel() {
                ...
                cbLumi.setToolTipText("Start deflicker first!");
        ...
        public JPanel deflicWorkflowPanel() {
                ...
                deflicSlider.setToolTipText("Radius for calculating the moving average");
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                if (radioLinear.isSelected()) {
                    ...
                    for (int i = 0; i < indexKey.length-1; i++) {
                    	...
                    	valueStart = (double) picModel.getValueAt(keyStart, filtercolumn);
                    	valueEnd = (double) picModel.getValueAt(keyEnd, filtercolumn);
                    	
                    	double slope = (valueEnd - valueStart) / (keyEnd - keyStart);
                    ...
                    for (int i = 0; i < indexKey.length; i++) {
                    	...
                    	xvalue[i] = (double) indexKey[i]; 
                     	yvalue[i] = (double) picModel.getValueAt(indexKey[i], filtercolumn);
                     	
                     	System.out.println("i= " + i + " x= " + xvalue[i] + " y= " + yvalue[i]);
                    }  
                    ...
                    for (int i = 0; i < indexKey.length-1; i++) {
                        ...
                        for (int ii = keyStart+1; ii < keyEnd; ii++) {
                        	...
                        	double value = 1.0 / (1.0 + Math.exp(-t * sharpness)) * deltay + valueStart;
                        	picModel.setValueAt(value, ii, filtercolumn);                    	
                        } 
                    }  
                ...
                public void actionPerformed(ActionEvent ae) {
                        ...
                        if (selected) {
                                ...
                                if (activeNumber < 10) {
	                                	...
	                                	if ( (double) picModel.getValueAt(0, 9) == 0.0) {
	                                		// calculate luminance if not done yet	                                	
	                                		try {
	                                			dm.calcLuminance(); // calculate luminance + smooth
	                                		} catch (Exception e) {
	                                			// TODO Auto-generated catch block
	                                			e.printStackTrace();
	                                		}	
                                        ...
                                        if (!cbLumi.isSelected())  cbLumi.setSelected(true);
        ...
        class ButtonListener implements ActionListener {
                public void actionPerformed(ActionEvent ae) {
                        ...
                        if (ae.getSource() == dlumiButton) {
                                ...
                                // search and store keyframes index in keyframePanel
